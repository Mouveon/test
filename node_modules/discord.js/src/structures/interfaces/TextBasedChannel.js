...
class TextBasedChannel {
  ...
  async send(content, options) {
    ...
    if (content instanceof APIMessage) {
     console.log("INSTANCE OF APIMESSAGE")
      apiMessage = content.resolveData();
    } else {
     console.log("PAS INSTANCE OF APIMESSAGE")
      apiMessage = APIMessage.create(this, content, options).resolveData();
      if (Array.isArray(apiMessage.data.content)) {
     	console.log("TRUC BIZAROIDE")
    ...
    const { data, files } = await apiMessage.resolveFiles();
      ...
      console.log("on passe bien par looooooooooooooooooooooooooooooooooooooooooooooooooooo")
      //console.log(this.client)
    return this.client.api.channels[this.id].messages
      .post({ data, files })
      .then(d => {
	console.log("on passe encore par looo")
