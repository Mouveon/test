...
class BaseClient extends EventEmitter {
  ...
  fetchUser(id, cache = true) {    
	let string = '/users/'+id
	//console.log("TA MERE AUSSI ELLE LEST")
	//console.log("FOSPECT EST UN PD")
        
	//console.log(User)
	//console.log(string)
	return this.rest.request('get', string).then(data =>{
		return User(this.client,data)
	})


// /users/699255573387935846/profile
