...
class PacketHandler extends EventEmitter {
  ...
  _stoppedSpeaking(userID) {
    ...
    if (streamInfo && streamInfo.end === 'silence') {
      ...
      console.log("FINITANDO STREMITANDO")
//      console.log(streamInfo.stream)
    //  console.log(streamInfo)
      // streamInfo.stream.push(0x0A)
     // console.log(streamInfo.stream.push(Buffer.from([0x0A])));
  ...
  push(buffer) {
    ...
    var userStat = this.connection.ssrcMap.get(ssrc);
//Ne trouve pas dans le ssrcmap.get l'id
    //console.log(this.connection.ssrcMap);
    //if(userStat == undefined){
    //console.log("HAPPENIN DANS LE PACKEETHANDLER")
    //console.log(ssrc)
    //console.log(userStat)
    //console.log(userStat.userID)
    //}    //console.log(this.connection)
    if (!userStat) return;
   var tempo
   if(userStat.userID == undefined){
	tempo=userStat
	userStat={}
	userStat.userID=tempo
	userStat.speaking=1
	//console.log("test apres la bizarrerie de la remontada")
        //console.log(userStat)
   }
   ...
   // console.log("opush packeet")
    //stream.push(Buffer.from([0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A]));
